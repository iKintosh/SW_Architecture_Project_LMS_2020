...
group281_x_philosophy = Curriculum(course_id=philosophy_course.id, group_num=group281.num)
group191_x_philosophy = Curriculum(course_id=philosophy_course.id, group_num=group191.num)
...
session.commit()
session.add_all([student_alice, student_john, tutor_ann, math_course, mem_course, philosophy_course, Kant_philosophy])
session.commit()
session.add_all([Matrix_math, Integral_math, homework1_philosophy, homework_matrix, john_answer_philosophy])
session.commit()
session.add_all([alice_answer_philosophy, group191_x_math, group191_x_philosophy, group281_x_philosophy])
session.commit()
